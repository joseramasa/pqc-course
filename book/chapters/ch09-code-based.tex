...
The three code-based KEMs examined in this chapter occupy distinct points in the design space, each resolving the tension between security confidence, key size, ciphertext size, and implementation maturity in a different way.  Table~\ref{tab:code-comparison} makes the trade-offs concrete.
